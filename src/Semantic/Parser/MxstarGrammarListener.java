...
public interface MxstarGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MxstarGrammarParser#declarationElement}.
	 * @param ctx the parse tree
	 */
	void enterDeclarationElement(MxstarGrammarParser.DeclarationElementContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxstarGrammarParser#declarationElement}.
	 * @param ctx the parse tree
	 */
	void exitDeclarationElement(MxstarGrammarParser.DeclarationElementContext ctx);
	/**
